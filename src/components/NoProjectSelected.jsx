...
export default function NoProjectSelected({onStartAddProject}) {
  return (
    <div className="m-auto flex flex-col items-center">
      ...
      <button onClick={onStartAddProject} className="md:px-5 md:py-3 px-3 py-2 rounded-md text-stone-400 bg-stone-700 font-semibold md:text-xl hover:bg-stone-600">Create new project</button>
    </div>
  );
}
